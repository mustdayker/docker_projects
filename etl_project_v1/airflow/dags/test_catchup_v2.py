...
with DAG(
        ...
        start_date=datetime(2024, 11, 1),  # Начинаем с 1 января 2024
        catchup=True,
        tags=['nyc_taxi', 'data_pipeline'],
        max_active_runs=1,  # ← Ключевая настройка
        # concurrency=1,  # ← Дополнительное ограничение
        # max_active_tasks=1,
) as dag:
